	...
	return (
		<footer className='bg-white dark:bg-gray-900'>
			<div className='mx-auto w-full max-w-screen-xl'>
				{/* top */}
				<div className='grid grid-cols-2 px-4 py-6 lg:py-8 gap-10 md:grid-cols-5'>
					<div>
					...
					<div>
						<div className='flex items-center border border-white/20 rounded-[10px] p-[15px_20px] w-[188px] h-[66px] bg-white/10 mt-3 cursor-pointer hover:bg-white/20'>
